...
# Default off: the advocate package (SSRF guard) pins urllib3<2; use
# REDASH_ENFORCE_PRIVATE_IP_BLOCK=true and pip install advocate only if you accept that constraint.
...
# Custom admin email
TEAMFORM_ADMIN_EMAIL = "admin@teamform.co"
